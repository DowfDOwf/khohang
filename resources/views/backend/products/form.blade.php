<form role="form" action="" method="POST" enctype="multipart/form-data">
    ...
    <div class="box-body">
        ...
        <div class="form-group {{ $errors->has('p_category_id') ? 'has-error' : '' }}">
            ...
            <span class="text-danger"><p class="mg-t-5">{{ $errors->first('p_category_id') }}</p></span>
        </div>
        ...
        <div class="form-group {{ $errors->has('p_status') ? 'has-error' : '' }}">
            ...
            <div class="checkbox" style="display: inline">
                <label>
                    <input type="radio" value="1" name="p_status"  {{ old('p_status', isset($product) ?  $product->p_status : '') == 1 ? "checked='checked'" : ""  }}> Đang bán
                </label>
            </div>
            <div class="checkbox" style="display: inline">
                <label>
        ...
        <div class="form-group {{ $errors->has('p_unit_id') ? 'has-error' : '' }}">
            ...
            <span class="text-danger"><p class="mg-t-5">{{ $errors->first('p_unit_id') }}</p></span>
        </div>
