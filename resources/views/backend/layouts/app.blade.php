...
<head>
    ...
    <link rel="stylesheet"
        href="{{ asset('admin/theme/bower_components/jquery-confirm/dist/jquery-confirm.min.css') }}">
    ...
    <aside class="main-sidebar">
        <section class="sidebar">
            <ul class="sidebar-menu" data-widget="tree" style="margin-top: 20px;">
                ...
                <li {!! isset($quantity_statistics) ? "class='active'" : '' !!}><a href="{!! route('quantity.statistics') !!}"><i class="fa fa-fw fa-area-chart"></i> <span>Thống kê SL hàng bán ra</span></a></li>
