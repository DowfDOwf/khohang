...
Route::group(['prefix' => 'system', 'namespace' => 'Backend', 'middleware' =>['auth']], function (){
    ...
    Route::group(['prefix' => 'warehouse'], function (){
        ...
        Route::get('/statistical', 'WarehouseController@statistical')->name('statistical');
        Route::get('/revenue', 'WarehouseController@revenue')->name('revenue');
        Route::get('/quantity-statistics', 'WarehouseController@quantityStatistics')->name('quantity.statistics');
    });
});